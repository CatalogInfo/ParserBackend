...
public class TelegramService {
    ...
    public static void sendMessage(String message) {
        try {
            ...
            com.example.backend_parser.telegram.services.TelegramService.getTelegram().sendMessage(decodedMessage);
        } catch (UnsupportedEncodingException e) {
            e.printStackTrace();
            com.example.backend_parser.telegram.services.TelegramService.getTelegram().sendMessage("Error in message decoding");
        }
    }
    ...
    public static void commandsHandler(String messageText, String chatId) {
        ...
        if(defineIsCommand(messageText)) {
            if (messageText.startsWith("/ban")) {
                ...
                apiCommunicator.banToken(banCommand.getToken(), banCommand.getExchange());
                ...
                apiCommunicator.unbanToken(banCommand.getToken(), banCommand.getExchange());
